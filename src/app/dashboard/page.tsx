      ...
      <div className="mx-auto max-w-7xl px-4 pb-16 pt-16 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="space-y-4">
            <h1 className="text-3xl md:text-4xl font-serif text-editorial-black tracking-tight">
              Welcome back, <span className="text-[#C5A059] italic">{session?.user?.name}</span>
            </h1>
            <p className="text-editorial-black/60 text-base md:text-lg font-serif italic">Curate your curriculum and engage with your academic circle.</p>
          </div>

          {/* Quick Stats */}
          <div className="flex flex-wrap gap-6 md:gap-8">
            <div className="pr-8 md:pr-12 md:border-r border-editorial-black/5">
              <p className="text-[10px] font-bold text-editorial-black/30 uppercase tracking-[0.2em] mb-3">Enrolled</p>
              <p className="text-4xl md:text-5xl font-serif text-editorial-black tracking-tighter">{enrolledCourses.length}</p>
            </div>
          </div>
        </div>
        ...
        <section className="mb-16 md:mb-32">
          <div className="mb-12">
            <h2 className="text-3xl md:text-4xl font-serif text-editorial-black">Current Curriculum</h2>
        ...
        <section className="mb-16 md:mb-24">
          <div className="p-6 md:p-16 border border-editorial-black/5 bg-editorial-black/[0.02] relative overflow-hidden">
            <div className="relative z-10">
              <h2 className="text-3xl md:text-4xl font-serif text-editorial-black mb-4 md:mb-6">Deepen your Expertise.</h2>
              <p className="text-editorial-black/60 text-base md:text-lg mb-8 md:mb-12 font-serif italic">We found these specialized modules from your trusted faculty members—designed to expand your academic horizon.</p>
