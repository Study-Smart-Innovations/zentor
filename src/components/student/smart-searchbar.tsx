        ...
        <div className="relative group">
          <div className="relative flex items-center">
            ...
            <input
              ...
              className="w-full h-16 md:h-24 pl-12 pr-12 bg-transparent border-b border-editorial-black/10 text-lg md:text-2xl font-serif italic text-editorial-black outline-none transition-all focus:border-editorial-black placeholder:text-editorial-black/20"
            />
            ...
            >
              ...
              {teacherProfile && (
                <motion.div
                  ...
                  className="mb-16 p-8 md:p-12 border border-editorial-black/5 bg-editorial-black/[0.01] relative overflow-hidden"
                >
                  <div className="absolute top-0 right-0 p-6 md:p-8">
                    <ShieldCheck className="h-10 w-10 md:h-12 md:w-12 text-[#C5A059]/10" />
                  </div>
                  ...
                  <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-8">
                    <div className="space-y-6">
                      ...
                      <h4 className="text-3xl md:text-5xl font-serif text-editorial-black tracking-tight italic">
                        {teacherProfile.name}
                      </h4>

                      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 pt-4">
                        <div className="border-b md:border-b-0 border-editorial-black/5 pb-4 md:pb-0">
              ...
              {results.length > 0 ? (
                <div className="grid gap-12 md:grid-cols-2">
                  {results.map((course) => (
                    <motion.div
                      key={course.id}
                      className="group flex flex-col sm:flex-row items-center sm:items-start space-y-6 sm:space-y-0 sm:space-x-8 pb-8 border-b border-editorial-black/5"
                    >
                      <div className="h-28 w-28 md:h-24 md:w-24 shrink-0 bg-editorial-black/5 filter grayscale-[0.5] group-hover:grayscale-0 transition-all duration-700 overflow-hidden shadow-sm">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <h4 className="font-serif text-lg md:text-xl text-editorial-black mb-3 group-hover:text-[#C5A059] transition-colors leading-tight text-center sm:text-left">
                          {course.title}
                        </h4>

                        <p className="text-[10px] font-bold text-editorial-black/40 uppercase tracking-widest text-center sm:text-left">
                      ...
                      <Link
                        ...
                        className="h-12 w-12 sm:h-10 sm:w-10 shrink-0 flex items-center justify-center rounded-full bg-editorial-black/5 text-editorial-black/40 group-hover:bg-editorial-black group-hover:text-white transition-all shadow-sm"
                      >
