      ...
      <div className="mx-auto max-w-7xl w-full text-center">
        ...
        >
          <h1 className="text-4xl sm:text-5xl lg:text-[6rem] font-black leading-[1.1] md:leading-[1.0] tracking-tighter text-editorial-black font-serif">
            ...
            <span className="text-xl sm:text-2xl lg:text-5xl block mt-6 md:mt-4 uppercase tracking-widest font-sans font-bold text-editorial-black/30">Education Meets Opportunity, Everywhere.</span>
          </h1>
          
          <p className="mt-10 md:mt-8 text-lg sm:text-2xl text-editorial-black/70 max-w-2xl leading-relaxed font-medium px-4">
            The edu-social platform connecting talent and ambition across every corner of the country.
          </p>
